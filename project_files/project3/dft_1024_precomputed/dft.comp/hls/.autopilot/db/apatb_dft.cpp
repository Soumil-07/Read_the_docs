...
extern "C"
void dft_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_dft_hw(void* __xlx_apatb_param_real_sample_V_data_V, void* __xlx_apatb_param_real_sample_V_keep_V, void* __xlx_apatb_param_real_sample_V_strb_V, void* __xlx_apatb_param_real_sample_V_last_V, void* __xlx_apatb_param_imag_sample_V_data_V, void* __xlx_apatb_param_imag_sample_V_keep_V, void* __xlx_apatb_param_imag_sample_V_strb_V, void* __xlx_apatb_param_imag_sample_V_last_V, void* __xlx_apatb_param_real_op_V_data_V, void* __xlx_apatb_param_real_op_V_keep_V, void* __xlx_apatb_param_real_op_V_strb_V, void* __xlx_apatb_param_real_op_V_last_V, void* __xlx_apatb_param_imag_op_V_data_V, void* __xlx_apatb_param_imag_op_V_keep_V, void* __xlx_apatb_param_imag_op_V_strb_V, void* __xlx_apatb_param_imag_op_V_last_V)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "real_sample_V_data_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_real_sample_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_real_sample_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_real_sample_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_real_sample_V_data_V),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_real_sample_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_real_sample_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_real_sample_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_real_sample_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_real_sample_V_keep_V),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_real_sample_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_real_sample_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_real_sample_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_real_sample_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_real_sample_V_strb_V),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_real_sample_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_real_sample_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_real_sample_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_real_sample_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_real_sample_V_last_V),
#endif
  };
  port3.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_real_sample_V_last_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_imag_sample_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_imag_sample_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_imag_sample_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_imag_sample_V_data_V),
#endif
  };
  port4.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_imag_sample_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_imag_sample_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_imag_sample_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_imag_sample_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_imag_sample_V_keep_V),
#endif
  };
  port5.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_imag_sample_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_imag_sample_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_imag_sample_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_imag_sample_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_imag_sample_V_strb_V),
#endif
  };
  port6.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_imag_sample_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_imag_sample_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_imag_sample_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_imag_sample_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_imag_sample_V_last_V),
#endif
  };
  port7.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_imag_sample_V_last_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_real_op_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_real_op_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_real_op_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_real_op_V_data_V),
#endif
  };
  port8.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_real_op_V_data_V;
  port8.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_real_op_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_real_op_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_real_op_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_real_op_V_keep_V),
#endif
  };
  port9.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_real_op_V_keep_V;
  port9.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_real_op_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_real_op_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_real_op_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_real_op_V_strb_V),
#endif
  };
  port10.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_real_op_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_real_op_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_real_op_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_real_op_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_real_op_V_last_V),
#endif
  };
  port11.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_real_op_V_last_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_imag_op_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_imag_op_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_imag_op_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_imag_op_V_data_V),
#endif
  };
  port12.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_imag_op_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_imag_op_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_imag_op_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_imag_op_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_imag_op_V_keep_V),
#endif
  };
  port13.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_imag_op_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_imag_op_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_imag_op_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_imag_op_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_imag_op_V_strb_V),
#endif
  };
  port14.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_imag_op_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_imag_op_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_imag_op_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_imag_op_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_imag_op_V_last_V),
#endif
  };
  port15.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_imag_op_V_last_V;

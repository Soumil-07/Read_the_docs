...
entity dft_dft_Pipeline_VITIS_LOOP_67_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of dft_dft_Pipeline_VITIS_LOOP_67_4 is 
...
attribute shreg_extract : string;
    ...
    signal imag_op_pkt_last_fu_160_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal imag_op_pkt_last_reg_201 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln67_fu_154_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_68 : STD_LOGIC_VECTOR (10 downto 0) := "00000000000";
    signal add_ln67_fu_148_p2 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    add_ln67_fu_148_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv11_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(real_op_TREADY, imag_op_TREADY)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((imag_op_TREADY = ap_const_logic_0) or (real_op_TREADY = ap_const_logic_0));
    end process;
    ...
    icmp_ln67_fu_142_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv11_400) else "0";
    imag_op_TDATA <= imag_op_data_q0;

    imag_op_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, imag_op_TREADY, ap_block_pp0_stage0)
    begin
    ...
    imag_op_TKEEP <= ap_const_lv4_F;
    imag_op_TLAST <= imag_op_pkt_last_reg_201;
    imag_op_TSTRB <= "XXXX";

    imag_op_TVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    imag_op_data_address0 <= zext_ln67_fu_154_p1(10 - 1 downto 0);
    ...
    imag_op_pkt_last_fu_160_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv11_3FF) else "0";
    real_op_TDATA <= real_op_data_q0;

    real_op_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, real_op_TREADY, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    real_op_TKEEP <= ap_const_lv4_F;
    real_op_TLAST <= imag_op_pkt_last_reg_201;
    real_op_TSTRB <= "XXXX";

    real_op_TVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    real_op_data_address0 <= zext_ln67_fu_154_p1(10 - 1 downto 0);
    ...
    zext_ln67_fu_154_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1),64));
end behav;
